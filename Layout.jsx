                ...
                <div className="flex items-center justify-between h-16 md:h-20">
                    ...
                    <div className="flex-shrink-0">
                        <Link to={createPageUrl('Home')} className="flex items-center gap-3 hover:scale-105 transition-transform duration-300" title="לוקרים חכמים אוטומטיים - דף הבית">
                            <div className="p-2 rounded-xl bg-gradient-to-br from-primary-500 to-secondary-600 shadow-lg shadow-primary-500/50">
                                <Box className="w-7 h-7 text-white" />
                            </div>
                            <div className="flex flex-col">
                                <span className="text-xl md:text-2xl font-black text-white leading-none">Lockey24</span>
                                <span className="text-xs text-primary-400 font-medium hidden sm:block">לוקרים חכמים</span>
                            </div>
                        </Link>
                    </div>
                            ...
                            {navLinks.filter(link => link.title !== 'פאנל ניהול').map((link) => {
                                ...
                                return (
                                    ...
                                    >
                                        {link.title}
                                        {isActive && (
                                            <span className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-primary-400 to-secondary-500"></span>
                                        )}
                                    </Link>
                                );
                            })}
                    ...
                    <div className="flex-shrink-0">
                        ...
                        <Link to={createPageUrl('Contact')} title="קבל הצעת מחיר ללוקר חכם" className="hidden md:block">
                            <button className="bg-gradient-to-r from-primary-500 to-secondary-600 text-white px-3 lg:px-6 py-2 lg:py-2.5 rounded-xl text-xs lg:text-base font-bold hover:from-primary-600 hover:to-secondary-700 hover:shadow-xl hover:shadow-primary-500/30 transition-all duration-300 shadow-lg transform hover:scale-105 whitespace-nowrap">
                                קבל הצעת מחיר
                            </button>
                        </Link>
                        ...
                        <button
                            onClick={toggleMenu}
                            className="md:hidden p-3 rounded-xl text-white bg-gradient-to-br from-primary-500/20 to-secondary-600/20 hover:from-primary-500/30 hover:to-secondary-600/30 border border-primary-500/30 transition-all duration-300 shadow-lg"
                            ...
                            <div className="py-6 space-y-1 px-2">
                                        ...
                                        >
                                            <Link
                                                ...
                                                className={`block px-5 py-4 text-base font-semibold rounded-xl transition-all duration-300 ${
                                                    isActive
                                                        ? 'text-white bg-gradient-to-r from-primary-500/30 to-secondary-600/30 border-r-4 border-primary-400 shadow-lg shadow-primary-500/20'
                                                        : isAdminLink
                                            ...
                                            >
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <ChevronRight className={`w-5 h-5 transition-transform ${isActive ? 'text-primary-400' : ''}`} />
                                                </div>
                                            </Link>
                                        </motion.div>
                                    );
                                ...
                                >
                                    <Link to={createPageUrl('Contact')} onClick={closeMenu} title="קבל הצעת מחיר ללוקר חכם">
                                        <button className="w-full bg-gradient-to-r from-primary-500 to-secondary-600 text-white px-6 py-4 rounded-xl font-bold hover:from-primary-600 hover:to-secondary-700 hover:shadow-xl hover:shadow-primary-500/30 transition-all duration-300 transform hover:scale-[1.02]">
                                            📞 קבל הצעת מחיר
                                        </button>
                                    </Link>
                                </motion.div>
            ...
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    <div className="lg:col-span-2">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-primary-400">לוקרים חכמים אוטומטיים לעתיד</div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-3">
                            <div className="px-4 py-2 rounded-full text-xs sm:text-sm font-bold text-white bg-gradient-to-r from-primary-500/20 to-secondary-600/20 border border-primary-500/30">
                                ✓ אפליקציה כלולה
                            </div>
                            <div className="px-4 py-2 rounded-full text-xs sm:text-sm font-bold text-white bg-gradient-to-r from-primary-500/20 to-secondary-600/20 border border-primary-500/30">
                                ✓ תחזוקה שוטפת
                            ...
                            {navLinks.map((link) => (
                                <li key={link.title}>
                                    <Link
                                        to={link.url}
                                        title={link.seoTitle}
                                        className="hover:text-primary-400 hover:translate-x-1 transition-all duration-300 flex items-center gap-2 text-gray-400"
                                    >
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link to={createPageUrl('Services')} className="hover:text-primary-400 hover:translate-x-1 transition-all duration-300 flex items-center gap-2 text-gray-400">
                                    <ChevronRight className="w-4 h-4 text-primary-500" />
                                    לוקרים חכמים להשכרה
                                </Link>
                            </li>
                            <li>
                                <Link to={createPageUrl('Products')} className="hover:text-primary-400 hover:translate-x-1 transition-all duration-300 flex items-center gap-2 text-gray-400">
                                    <ChevronRight className="w-4 h-4 text-primary-500" />
                            ...
                            <li>
                                <Link to={createPageUrl('Blog')} className="hover:text-primary-400 hover:translate-x-1 transition-all duration-300 flex items-center gap-2 text-gray-400">
                                    <ChevronRight className="w-4 h-4 text-primary-500" />
                                    מדריכים ובלוג
                                </Link>
                            </li>
                            <li>
                                <Link to={createPageUrl('Map')} className="hover:text-primary-400 hover:translate-x-1 transition-all duration-300 flex items-center gap-2 text-gray-400">
                                    <ChevronRight className="w-4 h-4 text-primary-500" />
                                    מפת לוקרים בישראל
                                </Link>
                            </li>
                            <li>
                                <Link to={createPageUrl('About')} className="hover:text-primary-400 hover:translate-x-1 transition-all duration-300 flex items-center gap-2 text-gray-400">
                                    <ChevronRight className="w-4 h-4 text-primary-500" />
                                    אודות החברה
                                </Link>
                            </li>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center gap-3 group hover:translate-x-1 transition-transform">
                                <div className="p-2 rounded-lg bg-gradient-to-br from-primary-500/20 to-secondary-600/20 border border-primary-500/30 group-hover:border-primary-500/50 transition-colors">
                ...
                <div className="mt-12 pt-8 border-t border-gray-800/50">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-gray-400">
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-4 text-sm">
                            <Link to={createPageUrl('Contact')} className="hover:text-primary-400 transition-colors font-medium">
                                קבע פגישת ייעוץ
                            </Link>
                            <span className="text-gray-700">|</span>
                            <Link to={createPageUrl('Products')} className="hover:text-primary-400 transition-colors font-medium">
                                קטלוג מוצרים
                            </Link>
                            <span className="text-gray-700">|</span>
                            <Link to={createPageUrl('Services')} className="hover:text-primary-400 transition-colors font-medium">
                                שירותים
                            </Link>
                        </div>
                    </div>
            ...
            <div className="relative z-10 max-w-2xl text-center">
                ...
                >
                    <motion.div
                        ...
                        className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 p-6 rounded-2xl border border-primary-500/30"
                    >
                        <Settings className="w-16 h-16 text-primary-400" />
                    </motion.div>
                    <motion.div
                        animate={{ rotate: [0, -360] }}
                        transition={{ duration: 4, repeat: Infinity, ease: "linear" }}
                        className="bg-gradient-to-r from-secondary-500/20 to-primary-600/20 p-6 rounded-2xl border border-secondary-500/30"
                    >
                        <Clock className="w-16 h-16 text-secondary-400" />
                    </motion.div>
                </motion.div>
