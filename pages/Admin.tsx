    ...
    return (
        <div dir="rtl" className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white p-4 sm:p-6 lg:p-8">
            <header className="mb-6 sm:mb-8">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black bg-gradient-to-r from-primary-400 to-secondary-500 bg-clip-text text-transparent">
                    פאנל ניהול
                </h1>
            ...
            <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
                ...
                <aside className="lg:w-1/4">
                    <Card className="bg-gray-800/50 backdrop-blur-lg border-gray-700 shadow-xl">
                        <CardHeader>
                            <CardTitle className="text-lg sm:text-xl text-primary-400">ניווט</CardTitle>
                        </CardHeader>
                        <CardContent>
                                ...
                                {tabs.map(tab => (
                                    <Button
                                        ...
                                        className={`justify-start gap-2 text-sm sm:text-base transition-all duration-300 ${
                                            activeTab === tab.id 
                                                ? 'bg-gradient-to-r from-primary-500 to-secondary-600 text-white shadow-lg shadow-primary-500/30 font-bold' 
