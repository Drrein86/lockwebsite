        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    ...
                    <Input 
                        ...
                        required 
                        className="bg-gray-800 border-gray-700 text-white h-12 md:h-14 text-base md:text-lg rounded-xl backdrop-blur-sm focus:border-purple-500 focus:ring-purple-500 transition-all duration-300"
                    />
                </div>
                <div className="space-y-2">
            ...
            <div className="space-y-2">
                ...
                <Textarea 
                    ...
                    onChange={handleChange} 
                    required  
                    className="bg-gray-800 border-gray-700 text-white text-base md:text-lg rounded-xl backdrop-blur-sm focus:border-purple-500 focus:ring-purple-500 transition-all duration-300 min-h-[120px] md:min-h-[140px] resize-none"
                    rows={5}
                />
            </div>
            ...
            {error && (
                ...
                className="w-full bg-gradient-to-r from-purple-500 to-violet-600 hover:from-purple-600 hover:to-blue-700 text-white font-bold py-4 rounded-xl transition-all duration-300 shadow-lg text-lg"
                >
                    {isSubmitting ? (
                    <>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mt-8 sm:mt-12">
                        <motion.div 
                            className="bg-gradient-to-br from-gray-900/80 to-gray-800/50 border border-gray-700 rounded-xl sm:rounded-2xl p-6 text-center hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20"
                            whileHover={{ scale: 1.02, y: -5 }}
                        >
                            <div className="bg-gradient-to-br from-purple-500/20 to-violet-600/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
