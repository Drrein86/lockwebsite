        ...
        <div>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-4">
                ...
                <Button 
                    ...
                    onClick={fetchLeads} 
                    disabled={isLoading}
                    className="bg-cyan-500/20 border-primary-500/50 hover:bg-cyan-500/30 text-primary-400"
                >
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="border-gray-700 hover:bg-gray-800/50">
                                <TableHead className="text-primary-400">תאריך</TableHead>
                                <TableHead className="text-primary-400">שם</TableHead>
                                <TableHead className="text-primary-400">אימייל</TableHead>
                                <TableHead className="text-primary-400">טלפון</TableHead>
                                <TableHead className="text-primary-400">הודעה</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {isLoading ? (
