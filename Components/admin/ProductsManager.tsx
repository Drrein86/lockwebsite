            ...
            {products.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {products.map(product => (
                        <div 
                            key={product.id} 
                            className="p-4 bg-gray-800/50 border border-gray-700 rounded-xl hover:border-purple-500/50 transition-all duration-300"
                        >
                            <div className="flex justify-between items-start mb-3">
                                <div className="flex-1">
                                    <h3 className="text-lg font-bold text-white mb-1">{product.name}</h3>
                                    {product.category && <span className="text-xs text-purple-400 bg-purple-500/20 px-2 py-1 rounded">{product.category}</span>}
                                </div>
                            </div>
                            ...
                            <div className="flex justify-between items-center">
                                <div className="text-sm">
                                    {product.price && <div className="text-purple-400 font-bold">₪{product.price}</div>}
