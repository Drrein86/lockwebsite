        ...
        <div>
            ...
            {contents.length === 0 ? (
                <div className="text-center py-12 bg-gray-800/30 rounded-xl border border-gray-700">
                    ...
                    <Button onClick={handleNew} variant="outline" className="border-cyan-500/50 text-primary-400 hover:bg-cyan-500/10">
                        ...
                        >
                            <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                    <code className="text-xs bg-gray-900 text-primary-400 px-2 py-1 rounded">{content.key}</code>
                                </div>
                            ...
                            <div className="flex gap-2">
                                <Button 
                                    ...
                                    className="border-cyan-500/50 text-primary-400 hover:bg-cyan-500/10"
                                >
