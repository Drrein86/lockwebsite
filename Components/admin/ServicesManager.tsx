            ...
            {services.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {services.map(service => (
                        <div 
                            key={service.id} 
                            className="p-5 bg-gray-800/50 border border-gray-700 rounded-xl hover:border-primary-500/50 transition-all duration-300"
                        >
                            <div className="flex justify-between items-start mb-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        {service.price && <p className="text-sm text-primary-400">{service.price}</p>}
                                    </div>
                                </div>
                            </div>
